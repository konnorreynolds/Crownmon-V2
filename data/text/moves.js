...
const MovesText = {
  ...
  "ed": {
    ...
    desc: "The user fails to get it up, the pure shame felt kills the user. The target gets so much second hand embarrasment it also just dies.",
    shortDesc: "User and target both just die."
 },
  absorb: {
    name: "Absorb",
