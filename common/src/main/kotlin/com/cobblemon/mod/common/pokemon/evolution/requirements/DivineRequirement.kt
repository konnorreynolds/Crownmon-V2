 ...
 */
class DivineRequirement : EvolutionRequirement {
    val isShiny: Boolean = true
    val minLevel = 1
    val maxLevel = Int.MAX_VALUE
    override fun check(pokemon: Pokemon) = isShiny.equals(pokemon.hasLabels("divine")).equals(pokemon.level in minLevel..maxLevel)
